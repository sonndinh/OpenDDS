...
public:
  ...
  bool begin_struct();
  bool end_struct();
  bool begin_struct_member(const DDS::MemberDescriptor& descriptor, DDS::ReturnCode_t rc, void* member_data);
...
private:
  // bool serialized_size_member_header(size_t& size, size_t& mutable_running_total, DDS::ReturnCode_t rc,
  //                                    DDS::ExtensibilityKind ek, CORBA::Boolean optional);
  // bool serialized_size_primitive_value(size_t& size, DDS::TypeKind member_tk);
  // void serialized_size_string_value(size_t& size, const char* str);
  // void serialized_size_wstring_value(size_t& size, const CORBA::WChar* wstr);
  // bool serialized_size_member(size_t& size, size_t& mutable_running_total, DDS::ExtensibilityKind ek,
  //                             const DDS::MemberDescriptor_var& md);
  // bool serialized_size_struct(size_t& size);

  // bool get_descriptor_value(CORBA::Long& disc_val, const DDS::DynamicType_var& disc_type);
  // bool serialized_size_enum(size_t& size, const DDS::DynamicType_var& enum_type);
  // bool serialized_size_discriminator(size_t& size, size_t& mutable_running_total,
  //                                    const DDS::DynamicType_var& disc_type, DDS::ExtensibilityKind ek);
  // bool serialized_size_union(size_t& size);

  // void serialized_size_primitive_elements(size_t& size, DDS::TypeKind elem_tk, CORBA::ULong length);
  // bool serialized_size_element(size_t& size, DDS::DynamicData_ptr col_data,
  //                              DDS::MemberId elem_id, DDS::TypeKind elem_tk);
  // bool serialized_size_collection(size_t& size);
...
bool Xcdr2ValueWriter::begin_struct()
{
  ...
  // Don't pop the dynamic data object until end_struct call.
...
//   CORBA::Long disc_val;
//   if (!get_discriminator_value(disc_val, disc_type)) {
//     return false;
//   }
...
// void Xcdr2ValueWriter::serialized_size_primitive_elements(size_t& size, DDS::TypeKind elem_tk, CORBA::ULong length)
// {
//   const Encoding& encoding = writer_.encoding();
//   using namespace OpenDDS::XTypes;
//   switch (elem_tk) {
...
//     serialized_size_primitive_elements(size, treat_elem_as, item_count);
//     return true;
//   }
...
//         !serialized_size_element(size, col_data, elem_id, treat_elem_as)) {
//       return false;
//     }
//   }
//   return true;
